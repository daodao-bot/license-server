...
public class TraceHelper {
    ...
    public Span createSpan(String traceId) {
        ...
        String spanId = randomHex(16).toLowerCase();
        try {
    ...
    private static String randomHex(int length) {
        return new Random().ints(length, 0, 16)
                .collect(StringBuilder::new, (sb, i) -> sb.append(Character.forDigit(i, 16)), StringBuilder::append)
                .toString()
                .toLowerCase();
    }
